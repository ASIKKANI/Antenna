...
async def run_cognitive_agent(
    ...
    prompt = (
        ...
        f"- If any task has a near deadline (e.g. less than 24 hours), be EXTREMELY strict. Distractions (even minor ones or unrelated productive activities) must result in a high d_weight (0.8+) and 'nagging_severe' animation. Nag the user heavily.\n"
